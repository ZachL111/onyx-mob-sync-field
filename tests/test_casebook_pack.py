"""Regression checks for the onyx-mob-sync-field casebook."""
...
from casebook.harness import assert_expected, onyx_mob_sync_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_mob_sync_field_summary(), assert_expected())
